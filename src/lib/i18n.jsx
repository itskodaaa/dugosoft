...
const translations = {
  ...
  nav_my_account:      { en: "My Account", it: "Il mio account",fr: "Mon compte",     es: "Mi cuenta",      de: "Mein Konto" },
  nav_sign_in:         { en: "Sign In",    it: "Accedi",       fr: "Connexion",       es: "Ingresar",       de: "Anmelden" },
  nav_get_started:     { en: "Get Started Free", it: "Inizia gratis", fr: "Essayer gratuitement", es: "Empezar gratis", de: "Kostenlos starten" },
  ...
  // Sidebar Groups
  side_group_docs:     { en: "Document Utilities", it: "Strumenti Documenti", fr: "Utilitaires Doc", es: "Utilidades Doc", de: "Dokument-Utilities" },
  side_group_career:   { en: "Career Accelerator", it: "Acceleratore Carriera", fr: "Accélérateur Carrière", es: "Acelerador Carrera", de: "Karriere-Beschleuniger" },
  side_group_sales:    { en: "Sales & Prospecting", it: "Vendite e Prospecting", fr: "Ventes et Prospection", es: "Ventas y Prospección", de: "Vertrieb & Akquise" },
  side_group_collab:   { en: "Collaboration & Chat", it: "Collaborazione e Chat", fr: "Collab et Chat", es: "Colaboración y Chat", de: "Kollaboration & Chat" },
  ...
  side_analytics:      { en: "Analytics", it: "Analisi", fr: "Analytique", es: "Analítica", de: "Analytik" },
  side_referral:       { en: "Referral", it: "Referral", fr: "Parrainage", es: "Referidos", de: "Referral" },
  side_upgrade:        { en: "Upgrade to Premium", it: "Passa a Premium", fr: "Passer à Premium", es: "Pasar a Premium", de: "Auf Premium upgraden" },
  side_unlock:         { en: "Unlock all tools & features", it: "Sblocca tutti gli strumenti", fr: "Débloquer tous les outils", es: "Desbloquear herramientas", de: "Alle Tools freischalten" },
  ...
  // Plans & Usage
  plan_free:           { en: "Free",       it: "Gratis",       fr: "Gratuit",      es: "Gratis",       de: "Kostenlos" },
  plan_pro:            { en: "Pro",        it: "Pro",          fr: "Pro",          es: "Pro",          de: "Pro" },
  plan_business:       { en: "Business",   it: "Business",     fr: "Business",     es: "Business",     de: "Business" },
  plan_label:          { en: "Plan",       it: "Piano",        fr: "Plan",         es: "Plan",         de: "Plan" },
  usage_today:         { en: "Today's Usage", it: "Utilizzo oggi", fr: "Usage du jour", es: "Uso de hoy", de: "Heutige Nutzung" },
  usage_unlimited:     { en: "Unlimited",  it: "Illimitato",   fr: "Illimité",     es: "Ilimitado",    de: "Unbegrenzt" },
  nav_upgrade_plan:    { en: "Upgrade Plan", it: "Aggiorna piano", fr: "Améliorer plan", es: "Mejorar plan", de: "Plan upgraden" },
  nav_sign_out:        { en: "Sign Out",   it: "Esci",         fr: "Déconnexion",  es: "Cerrar sesión",de: "Abmelden" },
  ...
  vp_overview: { en: 'Overview', it: 'Panoramica', fr: 'Aperçu', es: 'Resumen', de: 'Überblick' },
  vp_leadFinder: { en: 'Lead Finder', it: 'Trova Lead', fr: 'Trouver Leads', es: 'Buscar Leads', de: 'Lead-Finder' },
  vp_kanban: { en: 'Kanban Board', it: 'Bacheca', fr: 'Tableau', es: 'Tablero', de: 'Kanban-Board' },
  vp_aiMessages: { en: 'AI Messages', it: 'Messaggi IA', fr: 'Messages IA', es: 'Mensajes IA', de: 'KI-Nachrichten' },
  vp_campaigns: { en: 'Campaigns', it: 'Campagne', fr: 'Campagnes', es: 'Campañas', de: 'Kampagnen' },
  vp_inbox: { en: 'Inbox', it: 'Posta', fr: 'Boîte', es: 'Bandeja', de: 'Posteingang' },
  vp_resume: { en: 'Resume Intelligence', it: 'CV Intelligence', fr: 'CV Intelligence', es: 'Inteligencia CV', de: 'Lebenslauf-Intelligenz' },
  vp_interview: { en: 'Interview Prep', it: 'Colloquio', fr: 'Entretien', es: 'Entrevista', de: 'Interview-Vorbereitung' },
  vp_analytics: { en: 'Analytics', it: 'Analitica', fr: 'Analytique', es: 'Analíticas', de: 'Analytik' },
  vp_upgrade: { en: 'Upgrade', it: 'Aggiorna', fr: 'Améliorer', es: 'Mejorar', de: 'Upgrade' },
  ...
  vp_leadsContacted: { en: 'Leads Contacted', it: 'Lead Contattati', fr: 'Leads Contactés', es: 'Leads Contactados', de: 'Leads kontaktiert' },
  vp_replyRate: { en: 'Reply Rate', it: 'Tasso Risposta', fr: 'Taux Réponse', es: 'Tasa Respuesta', de: 'Antwortrate' },
  vp_interviewSuccess: { en: 'Interview Success', it: 'Successo Colloquio', fr: 'Succès Entretien', es: 'Éxito Entrevista', de: 'Interview-Erfolg' },
  vp_conversion: { en: 'Conversion', it: 'Conversione', fr: 'Conversion', es: 'Conversión', de: 'Konvertierung' },
  ...
  vp_role: { en: 'Role', it: 'Ruolo', fr: 'Poste', es: 'Rol', de: 'Rolle' },
  vp_location: { en: 'Location', it: 'Luogo', fr: 'Lieu', es: 'Ubicación', de: 'Standort' },
  vp_keywords: { en: 'Keywords', it: 'Parole chiave', fr: 'Mots-clés', es: 'Palabras clave', de: 'Schlüsselwörter' },
  vp_findLeads: { en: 'Find Leads', it: 'Trova', fr: 'Trouver', es: 'Buscar', de: 'Leads finden' },
  ...
  vp_open: { en: "Open", it: "Apri", fr: "Ouvrir", es: "Abrir", de: "Öffnen" },
  ...
  vp_regenerate: { en: "Regenerate", it: "Rigenera", fr: "Régénérer", es: "Regenerar", de: "Neu generieren" },
  vp_generate: { en: "Generate", it: "Genera", fr: "Générer", es: "Generar", de: "Generieren" },
