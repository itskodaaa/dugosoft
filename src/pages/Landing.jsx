        ...
        <div className="max-w-4xl mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/10 border border-accent/20 text-accent text-xs font-bold mb-4">
              <Play className="w-3.5 h-3.5 fill-current" /> See Dugosoft in Action
            </div>
            <h2 className="text-3xl font-black text-foreground mb-3">Watch How It Works</h2>
            <p className="text-muted-foreground max-w-xl mx-auto">See how thousands of professionals use Dugosoft to transform their documents and careers.</p>
          </motion.div>
          <motion.div initial={{ opacity: 0, scale: 0.97 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }}
            className="relative rounded-2xl overflow-hidden shadow-2xl border border-border aspect-video">
            <iframe
              src="https://www.youtube.com/embed/d92MdODEsi4?rel=0&modestbranding=1"
              title="Dugosoft Demo"
